...
# -------------------------
# 2️⃣ Function to train and evaluate AdaBoost
# -------------------------
def train_adaboost(X_train, X_test, y_train, y_test):
    ...
    return ada  # trained model

# -------------------------
# 3️⃣ Train and evaluate
# -------------------------
best_ada = train_adaboost(X_train, X_test, y_train, y_test)
...
model_save_path = os.path.join(models_dir, "adaboost_model.joblib")
joblib.dump(best_ada, model_save_path)
