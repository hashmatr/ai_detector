...
# Also drop length-based features to prevent bias (model was overfitting to length)
...
# -------------------------
# 2️⃣ Function to train and evaluate Random Forest
# -------------------------
def train_random_forest(X_train, X_test, y_train, y_test):
    # Train model (100 trees is a standard default)
...
# -------------------------
best_rf = train_random_forest(X_train, X_test, y_train, y_test)
