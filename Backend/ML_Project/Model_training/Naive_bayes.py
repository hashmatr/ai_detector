...
# -------------------------
# 2️⃣ Function to train and evaluate Naive Bayes
# -------------------------
def train_naive_bayes(X_train, X_test, y_train, y_test):
    ...
    return nb  # trained model

# -------------------------
# 3️⃣ Train and evaluate
# -------------------------
best_nb = train_naive_bayes(X_train, X_test, y_train, y_test)
...
model_save_path = os.path.join(models_dir, "naive_bayes_model.joblib")
